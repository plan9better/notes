State of a [System](System.md) refers to result of an observation which we can make that will tell us everything we need to know about a system to predict it's next state.
