In ML gradient descent i used to approximate the minimum of the [[error function]] (loss function) . By decrementing the X (guess) by the product of it's derivative and $\alpha$ (learning rate usually 0.01 / 0.1). 
![[gradient-descen.png]]
